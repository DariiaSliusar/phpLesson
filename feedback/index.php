...
<?php
  ...
  if(isset($_POST['submit'])) {
    ...
    if(empty($nameErr) && empty($emailErr) && empty($bodyEE)) {
...
<img src="/php-crash/feedback/img/logo.png" class="w-25 mb-3" alt="">
    ...
    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" class="mt-4 w-75">
      ...
      <div class="mb-3">
        ...
        <textarea class="form-control <?php echo $bodylErr ? 'is-invalid' : null; ?>" id="body" name="body" placeholder="Enter your feedback"></textarea>
        <div class="invalide-feedback">
       <?php echo $bodyErr; ?>
       </div>
      </div>
